...
2. Scan [agents/](agents/) and select the role that fits the task. State your selection. You may combine roles when a task spans multiple concerns.
...
- Respect the guardrails defined in each agent. Prohibited actions require human escalation—no exceptions.
